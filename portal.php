            ...
            <div class="row">
                <div class="col-md-4">
                    <a href="<?php echo base_url.'admin' ?>" class="portal-link">
                        <div class="card card-widget widget-user">
                            ...
                            <div class="widget-user-header bg-light-gray">
                            ...
                            <div class="card-footer bg-light-gray">
                                <div class="container">
                                    <p class="text-center text-black"><small><i>Click here to Admin Side</i></small></p>
                                </div>
                            </div>
                        </div>
                    </a>
                ...
                <div class="col-md-4">
                    <a href="<?php echo base_url.'faculty' ?>" class="portal-link">
                        <div class="card card-widget widget-user">
                            ...
                            <div class="card-footer bg-light-gray">
                                <div class="container">
                                    <p class="text-center text-black"><small><i>Click here to Establishment Side</i></small></p>
                                </div>
                            </div>
                        </div>
                    </a>
                ...
                <div class="col-md-4">
                    <a href="<?php echo base_url.'student' ?>" class="portal-link">
                        <div class="card card-widget widget-user">
                            <!-- Add the bg color to the header using any of the bg-* classes -->
                            <div class="widget-user-header bg-light-gray border-info">
                                <h3 class="widget-user-username">Student</h3>
                            </div>
                            <div class="widget-user-image">
                                <span class="img-circle elevation-2 fa fa-users portial-icon"></span>
                            </div>
                            <div class="card-footer bg-light-gray border-info">
                                <div class="container">
                                    <p class="text-center text-black"><small><i>Click here to Signin or Register</i></small></p>
                                </div>
                            </div>
                        </div>
                    </a>
